...
import { Bell, ChevronDown, Circle, Crown, Heart, LayoutGrid, Menu, Search, ShoppingBag, Smartphone, Star, Zap } from "lucide-react";
  ...
  return (
    <div className="bg-white">
      ...
      <div className="grid grid-cols-3 grid-rows-2">
        ...
        {
          DIFFERENT_SHOP.map(({ mark, slogan, img1, price1, img2, price2, img3, price3 }: Shop) => (
            <Card className="border border-zinc-400 rounded-lg bg-white w-60 h-44 flex" key={mark}>
              <div>
                <div className="flex">
                  <img
                    src="https://www.adaptivewfs.com/wp-content/uploads/2020/07/logo-placeholder-image.png"
